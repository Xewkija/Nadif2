...
-- Creates a new tenant and makes the calling user the owner.
-- Only works if user has no existing tenant memberships (first business only).
-- Uses SECURITY DEFINER to bypass RLS for atomic creation.
-- Handles concurrent requests gracefully via exception handling.
-- ============================================================================
